...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://9789-34-139-230-105.ngrok-free.app/predict", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ ...formData, disponsori: parseInt(formData.disponsori) }),
      });
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row gy-3 overflow-hidden">
                    {[
                      ...
                      { id: "tipe_pendaftaran", label: "Tipe Pendaftaran", type: "text" },
                      { id: "disponsori", label: "Disponsori", type: "number" },
                      { id: "nama_kemampuan", label: "Nama Kemampuan", type: "text" },
                    ].map((field) => (
                    ...
                    {[
                      ...
                      },
                      {
                        ...
                        options: ["Entry level", "Mid-Senior level", "Senior level"],
                      },
                      {
                        id: "jenis_pekerjaan",
                    ...
                    <div className="col-12 mt-4">
                      <div className="card">
                        <div className="card-body">
                          ...
                          <h6 className="card-text">Kategori Gaji Adalah: {hasilGaji}</h6>
                        </div>
                      </div>
                    </div>
                  </div>
